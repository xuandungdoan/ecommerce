...
@Component
class InitData(var roleRepository: RoleRepository, var userRepository: UserRepository, var productRepository: ProductRepository,var cartRepository: CartRepository) {
